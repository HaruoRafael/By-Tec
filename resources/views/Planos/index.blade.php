                    ...
                    <div class="mb-4">
                        <form action="{{ route('planos.index') }}" method="GET" class="flex flex-col sm:flex-row sm:space-x-4">
                            <div class="flex flex-wrap sm:flex-nowrap sm:space-x-4">
                                ...
                                <input type="number" id="valorPesquisa" name="valor" placeholder="Valor máximo" value="{{ Request::input('valor') }}" class="block w-full mb-4 sm:mb-0 sm:w-auto text-black rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                <input type="number" id="duracaoPesquisa" name="duracao" placeholder="Duração (meses)" value="{{ Request::input('duracao') }}" class="block w-full mb-4 sm:mb-0 sm:w-auto text-black rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                            </div>
                            <div class="flex flex-wrap w-full sm:w-auto">
                                ...
                                <a href="{{ route('planos.index') }}" class="bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-red-600 mb-2 sm:mb-0">Limpar Pesquisa</a>
                            </div>
                        </form>
                    </div>
