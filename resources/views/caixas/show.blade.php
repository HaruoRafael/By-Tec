        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-[#2d2d2d] overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-yellow-500 dark:text-yellow-500">
                    ...
                    @php
                    $totalVendasAtivas = $vendas->where('status', 'Ativo')->sum('valor'); // Somando as vendas ativas
                    ...
                    <table class="min-w-full bg-[#2d2d2d] mt-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border px-4 py-2">{{ $venda->descricao }}</td>
                    ...
                    <form action="{{ route('caixas.fechar', $caixa->id) }}" method="POST" class="mt-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" step="0.01" id="saldo_final" name="saldo_final" value="{{ number_format($saldoFinalCalculado, 2, '.', '') }}" class="mt-1 block w-full text-black rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                        </div>
